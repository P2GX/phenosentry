...
class TestPhenopacketStore:
    ...
    def test_from_notebook_dir(
        ...
        ps = DefaultPhenopacketStore.from_notebook_dir(fpath_nb_dir)
    ...
    def test_from_release_zip(
        ...
        with zipfile.ZipFile(fpath_ps_release_zip) as zf:
            ps = DefaultPhenopacketStore.from_release_zip(zf)
    ...
    def test_from_folder(
        ...
        ps = DefaultPhenopacketStore.from_folder(fpath_ps_folder)
        assert ps
    ...
    def test_from_file(
        ...
        ps = DefaultPhenopacketStore.from_file(fpath_ps_file)
        assert ps


def check_ps_specs(
    ps: DefaultPhenopacketStore,
):
    assert isinstance(ps, DefaultPhenopacketStore)
...
def check_aagab_cohort_specs(
    ...
    assert pp_ids == {
        ...
        "PMID_28239884_Family_4_proband",
    }
